    ...
    public class FormVencimientos : Form
    {
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Mostrar contenido (en una aplicación real, guardarías en archivo)
                MessageBox.Show("Exportación simulada:\n\n" +
                              contenido.Substring(0, Math.Min(contenido.Length, 300)) + "...",
                              "Vista previa de exportación", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
